...
void WaveDrive(void) {
    ...
    // Go through the various states
    switch (coilState) {
        
        case step_one:
            // Activate the positive A coil, deactivate all others
            COIL_A_DIRECTION = 1;
            COIL_A_DIRECTION_INV = 0;
            COIL_B_DIRECTION = 0;
            COIL_B_DIRECTION_INV = 0;
            
            // Move to next state if successful, otherwise move back to the previous state
            if (stepDir == FORWARD) {
                coilState = step_two;
            } else {
                coilState = step_four;
        ...
        case step_two:
            // Activate the positive B coil, deactivate all others
            COIL_A_DIRECTION = 0;
            COIL_A_DIRECTION_INV = 0;
            COIL_B_DIRECTION = 1;
            COIL_B_DIRECTION_INV = 0;
        ...
        case step_three:
            // Activate the negative A coil, deactivate all others
            COIL_A_DIRECTION = 0;
            COIL_A_DIRECTION_INV = 1;
            COIL_B_DIRECTION = 0;
            COIL_B_DIRECTION_INV = 0;
        ...
        case step_four:
            // Activate the negative B coil, deactivate all others
            COIL_A_DIRECTION = 0;
            COIL_A_DIRECTION_INV = 0;
            COIL_B_DIRECTION = 0;
            COIL_B_DIRECTION_INV = 1;
