...
typedef enum {
    ...
    // Tape          
    FL_TAPE_DETECTED,
    FL_TAPE_NOT_DETECTED,

    FR_TAPE_DETECTED,
    FR_TAPE_NOT_DETECTED,

    RL_TAPE_DETECTED,
    RL_TAPE_NOT_DETECTED,

    RR_TAPE_DETECTED,
    RR_TAPE_NOT_DETECTED,
...
#define SUB_BASIC_TRAVERSE_WATCHDOG_TIMER 7

#define BUFFER_TIMER 8 

#define GLOBAL_TIMER 9
